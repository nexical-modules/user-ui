  ...
  useEffect(() => {
    ...
    const mapError = (code: string | null) => {
      ...
      if (code === 'CredentialsSignin' || code === 'credentials')
        return t('user.auth.login.error.invalid_credentials');
      if (code === 'AccountDeactivated' || code === 'AccessDenied' || code === 'CallbackRouteError')
        return t('user.auth.login.error.account_deactivated');
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="auth-form-container" method="POST">
          ...
          <div className="auth-form-group">
            ...
            <Input
              id="identifier"
              type="text"
              placeholder={t('user.auth.login.identifier_placeholder', {
          ...
          >
            {isSubmitting
              ...
              : t('user.auth.login.submit_button')}
          </Button>
