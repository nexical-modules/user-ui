    ...
    if (status === 'loading') {
        return (
            <Card className="auth-card">
                <CardHeader>
                    <CardTitle className="auth-card-title">{t('user.pages.verify_email.verifying')}</CardTitle>
                </CardHeader>
            </Card>
        );
    }
    ...
    return (
        <Card className="auth-card">
            <CardHeader>
                ...
                >
                    {errorDetails ? t(`user.auth.verify.error.${errorDetails}`) || errorDetails : t('user.pages.verify_email.failed_message_default')}
                </CardDescription>
            </CardHeader>
            <CardContent className="auth-form-container">
                <a
